...
import NpsSurveyComponent from '../../components/survey/survey';
...
<div className="numbers">{userData.username}</div>
       ...
       <input type="text"placeholder="course" className="cardName" name="course" value={updatedUserData.course} onChange={handleInputChange} />
       <input type="text"placeholder="year" className="cardName" name="year" value={updatedUserData.year} onChange={handleInputChange} />
       <input 
  type="date"
...
/>
       ...
       <input type="text"placeholder="fullname" className="cardName" name="displayName" value={updatedUserData.displayName} onChange={handleInputChange} />
       <input type="text"placeholder="department" className="cardName" name="department" value={updatedUserData.department} onChange={handleInputChange} />
     </>
   ) : (
          <>
            <div className="numbers">{userData.username}</div>
            ...
            <div className="cardName">Department: {userData.department}</div>
            {passwordEditMode && (
