...
import '../../userComponents/usercalendar/usercalendar.css';
        ...
        const fetchEvents = async () => {
          try {
            ...
            const events = querySnapshot1.docs.map((doc) => ({
              id: doc.id,
              ...doc.data(),
              title: `Guidance Counseling with ${doc.data().username} Counselor: ${doc.data().counselor}`,
            }));
...
{filterEvents().map((event) => (
  ...
  <ListItem key={event.id} className="schedule-item" >
    <ListItemText
          ...
          secondary={
            <>
             Scheduled by:{event.username}<br/>
...
<NotificationComponent/>
      ...
      <Modal open={modalOpen && selectedTime !== null} onClose={handleCloseModal}>
        ...
        >
          ...
          <FormControl fullWidth margin="normal">
            ...
            >
              <MenuItem value="Schedule Counseling">Schedule Counseling</MenuItem>
 ...
 <div style={{display:"flex"}}>
      ...
      />
        ...
        <div>
          <Button style={{ marginRight: "5px" }} variant="contained" onClick={eventType === "Schedule Counseling" ? handleAddEvent : handleAddEventToEventsDatabase} sx={{ bgcolor: '#b46279', '&:hover': { bgcolor: '#8a344c' } }}>
        ...
        >
          ...
          {clickedEvent && (
            <>
              ...
              {clickedEvent.title === 'Guidance Counseling' && (
      <>
        <Typography variant="body1" gutterBottom>
          Counselor: {clickedEvent.extendedProps.counselor}
        </Typography>
        <Typography variant="body1" gutterBottom>
          Scheduled By: {clickedEvent.extendedProps.username}
        </Typography>
      </>
    )}
              <Typography variant="subtitle1" gutterBottom>
