...
const Users = () => {
    ...
    function CustomToolbar() {
        ...
        alignItems:"center", backgroundColor:"#8a344c", color:"white"}}> <h2>GA-BAI Users Reports</h2> </div> <hr/>
            ...
            <div style={{ height: 500, width: '94%' ,margin:'30px' }}>
                <DataGrid
                    ...
                    columns={[
                        ...
                        { field: 'displayName', headerName: 'Full Name', width: 100  },
                        { field: 'username', headerName: 'Username', width: 100  },
                        { field: 'studentNumber', headerName: 'Student No.', width: 150  },
                        { field: 'department', headerName: 'department', width: 150  },
                        { field: 'course', headerName: 'Course', width: 150  },
                        { field: 'year', headerName: 'Year', width: 50  },
                        { field: "timeStamp", headerName: "Timestamp", width: 150 , renderCell: (params) => moment(params.value.toDate()).format("MMMM DD, YYYY") }
