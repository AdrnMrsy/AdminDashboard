...
const Messagetable = () => {
    ...
    function CustomToolbar() {
        ...
        alignItems:"center", backgroundColor:"#8a344c", color:"white"}}> <h2>GA-BAI Message Reports</h2> </div> <hr/>
        ...
        <div>
            ...
            <div style={{ height: 500, width: '94%' ,margin:'30px' }}>
                <DataGrid
                    ...
                    columns={[
                        { field: "id", headerName: "Message ID", width: 100 },
                        { field: 'like', headerName: 'Like', width: 50  },
                        { field: 'comment', headerName: 'Comment', width: 50  },
