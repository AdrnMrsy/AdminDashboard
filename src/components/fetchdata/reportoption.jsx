...
const ReportOptions = ({ threadId, userRole, currentUsername,thread, username, currentuser}) => {
...
//   };
  ...
  return (
    <div>
      ...
      >
       <MenuItem onClick={() => { handleMenuClose(); setRemoveModalOpen(true) }}>Remove</MenuItem>
